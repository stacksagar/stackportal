...
import { HomeFeatureSection2 } from './HomeFeatureSection';
  ...
  return (
    <section className="bg-white dark:bg-dark relative overflow-hidden">
      <div className="responsive relative py-24">
        ...
        <div className="w-9/12 lg:w-7/12 pb-5 pt-20 relative z-20 overflow-hidden">
          <h1
          ...
          <h1
            ...
            className="text-6xl bg-clip-text bg-gradient-to-r from-yellow-600 dark:from-yellow-500 to-pink-500 tracking-tight -ml-1"
          >
            Beautifier
          </h1>

          <div className="flex items-center space-x-5 uppercase my-5">
        ...
        <div className="absolute left-3/4 lg:left-2/4 top-0 w-pixel_1200 pt-5 overflow-y-hidden h-pixel_650 ">
          <div
            style={{
              background: `${
                state.thememode == 'dark'
                  ? 'linear-gradient(10deg,#151f33,#151f3399,transparent,transparent,transparent)'
                  : 'linear-gradient(0deg, #fff,  rgba(255, 255, 255, 0.68),#fff0,#fff0,#fff0)'
              }`,
            }}
            className="w-full h-pixel_650 absolute top-0 left-0"
          />
